classdef minimal_datepicker < matlab.apps.App
    ...
    methods
        ...
        function DatePickerValueChanged(app, event)
            ...
            app.DatePickerOutputTextArea.Value = strsplit(strtrim(capturedOutput), newline);
        end
    end
...
<?xml version='1.0' encoding='UTF-8'?>
<InternalData>
    <AppId>9c0d1e2f-3a4b-5678-cdef-678901234567</AppId>
