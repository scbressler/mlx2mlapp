classdef output_right_plot < matlab.apps.App
    ...
    <UIFigure name='UIFigure'>
        ...
        <Children>
            <Label name='Label_1'>
                ...
                <Position>[20 700 520 40]</Position>
                <Text>'Sine Wave Demo'</Text>
            </Label>
            <Label name='Label_2'>
                <Position>[20 668 520 22]</Position>
                <Text>'This plots a sine wave'</Text>
                <WordWrap>'on'</WordWrap>
            </Label>
            <UIAxes name='UIAxes'>
                <Position>[560 300 520 440]</Position>
