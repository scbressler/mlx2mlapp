classdef TestSliderManualTicks < matlab.apps.App
...
<Components>
    <UIFigure name='UIFigure'>
        ...
        <Children>
            <Slider name='Slider'>
                <Limits>[1 30]</Limits>
                <MajorTicks>[1 10 20 30]</MajorTicks>
                <MajorTickLabels>{'1' '10' '20' '30'}</MajorTickLabels>
                <MajorTicksMode>'manual'</MajorTicksMode>
                <MinorTicks>[]</MinorTicks>
                <MinorTicksMode>'manual'</MinorTicksMode>
                <Position>[20 400 1060 3]</Position>
                <Value>6</Value>
...
<?xml version='1.0' encoding='UTF-8'?>
<AppDetails>
    <Name>TestSliderManualTicks</Name>
    <Version>1.0</Version>
</AppDetails>
%}
...
<?xml version='1.0' encoding='UTF-8'?>
<InternalData>
    <AppId>33333333-aaaa-bbbb-cccc-dddddddddddd</AppId>
